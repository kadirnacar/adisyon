...
type Props = NavigationInjectedProps &
  TurnikeCheckSelectProps &
  ApplicationState;

class TurnikeCheckSelectInfoComp extends Component<
  Props,
  TurnikeCheckSelectState
> {
  constructor(props) {
    super(props);
    this.state = {
...
export const TurnikeCheckSelect = withNavigation(
  connect(
    (state: ApplicationState) => state,
    dispatch => {
      return {
        TurnikeCheckSelectActions: bindActionCreators(
          {...ActivityActions},
          dispatch,
        ),
      };
    },
  )(TurnikeCheckSelectInfoComp),
) as any;
