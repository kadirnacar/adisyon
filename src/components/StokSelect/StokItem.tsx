      ...
      <View
        ...
        <View
          ...
          <Text
            style={{
              flex: 1,
              color: contrast(stok.group ? stok.group.color : ''),
              flexDirection: 'row',
              fontSize: 15,
        ...
        {this.props.addable ? (
          <View
            ...
            <TouchableHighlight
              ...
              onPress={() => {
                if (this.props.onRemovePress) this.props.onRemovePress(item);
                this.setState({});
              }}>
            ...
            <TouchableHighlight
              ...
              onPress={() => {
                if (this.props.onAddPress) this.props.onAddPress(item);
                this.setState({});
              }}>
              <Icon
                name="plus"
        ...
        <View style={{}}>
          {item && item.QUANTITY > 0 ? (
            <TextInput
              ...
              onFocus={() => {
                if (this.props.onTextActive) this.props.onTextActive(item);
              }}
              style={{
                width: '100%',
...
export const StokItem = withNavigation(
  connect(
