  ...
  static navigationOptions = ({navigation}) => {
    return {
      ...
      headerRight: props => {
        ...
        return state.Application.current == Applications.Siparis ? (
          <TouchableHighlight
          ...
          onReadTag={async tag => {
            ...
            if (!isFind) {
              ...
              if (this.props.Application.current == Applications.Siparis) {
                ...
                this.props.Application.current == Applications.AktiviteSatis
              ) {
                this.setState({isRequest: false});
                this.props.navigation.navigate('Aktivite');
              } else if (
                this.props.Application.current == Applications.AktiviteKontrol
              ) {
                const result = await this.props.ActivityOrderActions.checkItem(
                  this.props.ActivityOrder.checkItem,
                  this.props.ActivityOrder.checkItemSeance,
                  tag,
                );
                this.setState({isRequest: false});
                if (result) {
                ...
                this.props.Application.current == Applications.Turnike
              ) {
                const result = await this.props.ActivityOrderActions.checkItem(
                  this.props.ActivityOrder.checkItem,
                  null,
                ...
                this.props.Application.current == Applications.CustomerInfo
              ) {
...
export const Nfc = withNavigation(
  connect(
